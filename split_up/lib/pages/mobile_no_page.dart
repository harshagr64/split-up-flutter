...
class MobileNoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void _validateTextFieldData() {
      String mobile = mobileFieldControlller.text.trim();
    }
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: authController.isMobileValid
